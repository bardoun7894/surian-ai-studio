                    ...
                    <div key={response.id} className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-gray-500">
                          {new Date(response.created_at).toLocaleString(language === 'ar' ? 'ar-SY-u-nu-latn' : 'en-US')}
                        </span>
                      </div>
                  ...
                  {logs.map((log) => (
                    <div key={log.id} className="flex items-start gap-3 text-sm border-b border-gray-100 pb-3 last:border-0">
                      ...
                      <div className="flex-1">
                        ...
                        <span className="text-xs text-gray-500">
                          {new Date(log.created_at).toLocaleString(language === 'ar' ? 'ar-SY-u-nu-latn' : 'en-US')}
                        </span>
                      </div>
                    </div>
                  ))}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">
                    {complaint.created_at
                      ? new Date(complaint.created_at).toLocaleDateString(language === 'ar' ? 'ar-SY-u-nu-latn' : 'en-US')
                      : '-'}
                  </span>
                </div>
              </div>
