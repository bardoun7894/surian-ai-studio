...
const GovernmentPartners: React.FC = () => {
    ...
    return (
        <section className="py-16 bg-gov-beige dark:bg-gov-forest/30 border-t border-gov-gold/10 dark:border-gov-gold/10 transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mt-6 md:hidden">
                    <div className="flex items-center gap-2 text-xs text-gov-sand">
                        <span className="w-8 h-0.5 bg-gov-gold/20 dark:bg-gov-gold/10 rounded-full"></span>
