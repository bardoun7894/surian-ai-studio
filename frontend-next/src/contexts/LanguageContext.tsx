...
const translations: Record<string, Record<Language, string>> = {
  ...
  'complaint_prev_ticket_hint': { ar: 'يرجى إدخال رقم التذكرة للشكوى السابقة لربطها بهذه الشكوى وتسريع المعالجة.', en: 'Please enter the previous ticket number to link it to this complaint and speed up processing.' },
  ...
  'complaint_verify_ticket_id': { ar: 'تأكد من صحة رقم التذكرة والرقم الوطني', en: 'Please verify the ticket number and national ID' },
