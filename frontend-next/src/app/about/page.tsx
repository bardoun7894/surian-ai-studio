            ...
            <main className="flex-grow pt-20 md:pt-24">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {/* Values */}
                        {values.length > 0 && (
                            <div className="py-20 bg-gov-beige dark:bg-dm-bg/50">
                                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                        {values.map((value, index) => (
                                            <div key={index} className="bg-white dark:bg-dm-surface p-8 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-2 transition-all duration-300 border border-gray-100 dark:border-white/5 group">
                        ...
                        {/* Strategic Goals */}
                        {goals.length > 0 && (
                            <div className="py-20 bg-white dark:bg-dm-bg border-t border-gray-100 dark:border-gov-border/15">
                                <div className="max-w-4xl mx-auto px-4">
                                    ...
                                    <div className="space-y-6">
                                        {goals.map((goal, i) => (
                                            <div key={i} className="flex items-start gap-4 p-4 rounded-xl bg-gov-beige/30 dark:bg-dm-surface hover:bg-gov-beige dark:hover:bg-white/10 transition-colors">
