                  ...
                  {section.items.map((item, itemIdx) => {
                    ...
                    return (
                      <Link
                        ...
                        href={item.href}
                        onClick={onClick}
                        className="flex items-center gap-3 px-4 py-2.5 last:pb-1.5 text-sm text-gov-charcoal dark:text-white/90 hover:bg-gov-beige/50 dark:hover:bg-white/10 transition-colors group"
                      >
                        {Icon && (
                          <div className="w-8 h-8 rounded-lg bg-gov-beige/60 dark:bg-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-gov-gold/15 dark:group-hover:bg-gov-gold/15 transition-colors">
                            <Icon
                              size={16}
                              className="text-gov-forest dark:text-white group-hover:text-gov-gold dark:group-hover:text-gov-gold transition-colors"
                            />
                          </div>
                        )}
                        <div className="min-w-0">
                          ...
                          {item.description && (
                            <span className="block text-xs text-gray-400 dark:text-white/40 mt-0.5 line-clamp-1">
                              {item.description}
                            </span>
                          )}
                        </div>
