                    ...
                    {getAnnouncements(language).slice(0, 6).map((announcement) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Description */}
                                <p className="text-gov-stone/60 dark:text-gov-beige/60 text-sm mb-6 line-clamp-2 leading-relaxed font-medium">
                                    {announcement.description}
                                </p>

                                {/* Read More */}
                                <div className="flex items-center gap-2 text-gov-forest dark:text-gov-gold font-bold text-[10px] uppercase tracking-[0.2em] group-hover:gap-4 transition-all mt-auto pt-4 border-t border-gov-gold/10 dark:border-white/5">
