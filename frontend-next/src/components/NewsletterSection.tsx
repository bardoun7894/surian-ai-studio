...
const NewsletterSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gov-forest via-gov-teal to-gov-forest dark:from-dm-surface dark:via-dm-surface dark:to-dm-surface relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-display font-bold text-white dark:text-gov-teal mb-4">
          {t('nl_title')}
        </h2>
        <p className="text-white/70 dark:text-white/70 text-lg max-w-2xl mx-auto mb-10">
          {t('nl_subtitle')}
        </p>
        ...
        {subscribed ? (
          <div className="flex items-center justify-center gap-3 text-white bg-white/10 backdrop-blur-sm rounded-2xl px-8 py-6 max-w-md mx-auto border border-white/10">
            ...
            <span className="font-bold">{t('newsletter_subscribed')}</span>
          </div>
        ) : (
