    ...
    return (
        <div className="min-h-screen flex flex-col bg-gov-beige dark:bg-dm-bg transition-colors duration-500">
            ...
            <main className="flex-grow">
                {/* Hero Section */}
                <div className="relative pt-20 pb-12 md:pt-32 md:pb-24 bg-gov-forest dark:bg-gov-forest/80 text-white overflow-hidden">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                        <h1 className="text-2xl md:text-4xl font-display font-bold mb-4 md:mb-6 animate-fade-in-up">
                            {language === 'ar' ? 'عن الوزارة' : 'About The Ministry'}
                        </h1>
                        <p className="text-base md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-100">
                            {language === 'ar'
                ...
                {loading ? (
                    ...
                    <>
                        {/* Vision & Mission */}
                        <div className="py-10 md:py-20 bg-gradient-to-br from-white to-gov-beige/30 dark:from-dm-bg dark:to-dm-bg relative overflow-hidden">
                            ...
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                                    ...
                                    {/* Vision Card */}
                                    <div className="group relative bg-white dark:bg-dm-surface rounded-2xl md:rounded-3xl p-5 md:p-10 border border-gray-100 dark:border-gov-border/15 shadow-lg hover:shadow-xl hover:shadow-gov-gold/10 dark:hover:shadow-gov-gold/5 transition-all duration-500 overflow-hidden">
                                        ...
                                        <div className="relative z-10">
                                            <div className="w-12 h-12 md:w-16 md:h-16 bg-gov-forest dark:bg-gov-gold rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6 shadow-md transform group-hover:-translate-y-1 transition-transform duration-300">
                                                <Eye size={32} className="text-white dark:text-gov-forest" />
                                            </div>

                                            <h2 className="text-xl md:text-3xl font-display font-bold text-gov-forest dark:text-gov-gold mb-3 md:mb-4 group-hover:text-gov-emerald dark:group-hover:text-gov-gold transition-colors">
                                                {language === 'ar' ? 'رؤيتنا' : 'Our Vision'}
                                            </h2>

                                            <p className="text-sm md:text-lg text-gray-600 dark:text-white/70 leading-relaxed">
                                    ...
                                    {/* Mission Card */}
                                    <div className="group relative bg-white dark:bg-dm-surface rounded-2xl md:rounded-3xl p-5 md:p-10 border border-gray-100 dark:border-gov-border/15 shadow-lg hover:shadow-xl hover:shadow-gov-teal/10 dark:hover:shadow-gov-teal/5 transition-all duration-500 overflow-hidden">
                                        ...
                                        <div className="relative z-10">
                                            <div className="w-12 h-12 md:w-16 md:h-16 bg-gov-emerald dark:bg-gov-teal rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6 shadow-md transform group-hover:-translate-y-1 transition-transform duration-300">
                                                <Target size={32} className="text-white" />
                                            </div>

                                            <h2 className="text-xl md:text-3xl font-display font-bold text-gov-forest dark:text-gov-gold mb-3 md:mb-4 group-hover:text-gov-emerald dark:group-hover:text-gov-teal transition-colors">
                        ...
                        {/* Values */}
                        {values.length > 0 && (
                            <div className="py-10 md:py-20 bg-gov-beige dark:bg-dm-bg">
                                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
                                        {values.map((value, index) => (
                                            <div key={index} className="bg-white dark:bg-dm-surface p-4 md:p-8 rounded-xl md:rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-2 transition-all duration-300 border border-gray-100 dark:border-gov-border/15 group">
                                                <div className="w-10 h-10 md:w-14 md:h-14 bg-gov-forest/5 dark:bg-white/10 text-gov-forest dark:text-gov-gold rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-6 group-hover:bg-gov-forest group-hover:text-white dark:group-hover:bg-gov-gold dark:group-hover:text-gov-forest transition-colors">
                                                    {ICON_MAP[value.icon] || <Shield size={32} />}
                                                </div>
                                                <h3 className="text-sm md:text-xl font-bold text-gov-forest dark:text-gov-gold mb-1 md:mb-3">
                                                    {language === 'en' && value.title_en ? value.title_en : value.title_ar}
                                                </h3>
                                                <p className="text-gray-600 dark:text-white/70 text-xs md:text-sm leading-relaxed">
                        ...
                        {/* Strategic Goals */}
                        {goals.length > 0 && (
                            <div className="py-10 md:py-20 bg-gov-beige dark:bg-dm-bg border-t border-gray-100 dark:border-gov-border/15">
                                <div className="max-w-4xl mx-auto px-4">
                                    ...
                                    <div className="space-y-3 md:space-y-6">
                                        {goals.map((goal, i) => (
                                            <div key={i} className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl bg-gov-beige/30 dark:bg-dm-surface hover:bg-gov-beige dark:hover:bg-gov-card/10 transition-colors border border-transparent dark:border-gov-border/15">
                                                <CheckCircle className="text-gov-teal mt-1 shrink-0" size={24} />
                                                <p className="text-sm md:text-lg text-gov-charcoal dark:text-white/70 font-medium">
