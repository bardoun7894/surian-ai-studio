...
@section('title', 'إضافة رابط سريع - وزارة الاقتصاد')
...
<div class="max-w-3xl mx-auto">
    ...
    <nav class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
        ...
        <span class="material-symbols-outlined text-[16px] rtl-flip">chevron_left</span>
        <span class="text-slate-900 dark:text-white font-medium">إضافة رابط</span>
    </nav>

    <!-- Header -->
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">إضافة رابط سريع</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">إضافة رابط جديد للعرض في الموقع</p>
        </div>
    ...
    <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div class="bg-primary px-6 py-4">
            <h2 class="text-white font-bold text-sm flex items-center gap-2">
                ...
                بيانات الرابط السريع
            </h2>
        </div>

        <form action="{{ route('admin.quick-links.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100 dark:border-slate-700">
                    ...
                    <div>
                        ...
                        <input type="text" name="label_ar" value="{{ old('label_ar') }}" required
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100 dark:border-slate-700">
                    ...
                    <div>
                        ...
                        <input type="text" name="label_en" value="{{ old('label_en') }}" dir="ltr"
                            class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100 dark:border-slate-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="url" name="url" value="{{ old('url') }}" required dir="ltr"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
