...
const NewsSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-white" id="news-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
           <div>
              <h2 className="text-3xl font-display font-bold text-gov-charcoal mb-2">المركز الإعلامي</h2>
              <p className="text-gray-500">آخر الأخبار والمراسيم والقرارات الحكومية</p>
           </div>
           <button className="hidden md:flex items-center gap-2 text-gov-emerald font-bold hover:text-gov-emeraldLight transition-colors">
             عرض الأرشيف
             <ChevronLeft size={20} />
           </button>
        </div>
