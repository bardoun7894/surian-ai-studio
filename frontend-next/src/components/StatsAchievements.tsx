...
const StatsAchievements: React.FC = () => {
  ...
  const stats: StatItem[] = [
    ...
    },
    {
      ...
      iconBg: 'bg-gov-forest/80 border border-white/10', // Forest
      delay: 0.1
    },
    {
      id: 'complaints',
  ...
  return (
    <section className="py-24 bg-gov-forest relative overflow-hidden" ref={containerRef}>
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-gov-gold/5 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-gov-teal/5 rounded-full blur-[100px] pointer-events-none"></div>
