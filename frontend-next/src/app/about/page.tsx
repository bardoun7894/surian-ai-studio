        ...
        <div className="min-h-screen flex flex-col bg-gov-beige dark:bg-black transition-colors duration-500">
            ...
            <main className="flex-grow pt-14 md:pt-16">
                ...
                {loading ? (
                    ...
                    <>
                        {/* Vision & Mission */}
                        <div className="py-20 bg-gradient-to-br from-white to-gov-beige/30 dark:from-gov-forest dark:to-gov-forest/90 relative overflow-hidden">
                            {/* Decorative Background Elements */}
                            <div className="absolute top-0 right-0 w-96 h-96 bg-gov-gold/5 dark:bg-gov-gold/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                            <div className="absolute bottom-0 left-0 w-96 h-96 bg-gov-teal/5 dark:bg-gov-teal/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>

                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">

                                    {/* Vision Card */}
                                    <div className="group relative bg-white dark:bg-gov-emeraldStatic rounded-3xl p-8 md:p-10 border border-gray-100 dark:border-white/10 shadow-lg hover:shadow-xl hover:shadow-gov-gold/10 dark:hover:shadow-gov-gold/5 transition-all duration-500 overflow-hidden">
                                        <div className="absolute top-0 right-0 w-32 h-32 bg-gov-gold/10 rounded-bl-[100px] -mr-8 -mt-8 transition-transform group-hover:scale-110 duration-700"></div>
                                    ...
                                    {/* Mission Card */}
                                    <div className="group relative bg-white dark:bg-gov-emeraldStatic rounded-3xl p-8 md:p-10 border border-gray-100 dark:border-white/10 shadow-lg hover:shadow-xl hover:shadow-gov-teal/10 dark:hover:shadow-gov-teal/5 transition-all duration-500 overflow-hidden">
                                        <div className="absolute top-0 right-0 w-32 h-32 bg-gov-teal/10 rounded-bl-[100px] -mr-8 -mt-8 transition-transform group-hover:scale-110 duration-700"></div>
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                                                ...
                                                {language === 'ar'
                                                    ...
                                                    : (mission || 'The Ministry of Economy and Industry works to promote sustainable economic growth and support productive sectors through effective economic policies, a stimulating investment environment, and advanced digital services.')}
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                        {values.map((value, index) => (
                                            <div key={index} className="bg-white dark:bg-gov-emeraldStatic p-8 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-2 transition-all duration-300 border border-gray-100 dark:border-white/5 group">
                            ...
                            <div className="py-20 bg-white dark:bg-gov-forest border-t border-gray-100 dark:border-gov-gold/10">
                                <div className="max-w-4xl mx-auto px-4">
                                    ...
                                    <div className="space-y-6">
                                        {goals.map((goal, i) => (
                                            <div key={i} className="flex items-start gap-4 p-4 rounded-xl bg-gov-beige/30 dark:bg-gov-emeraldStatic hover:bg-gov-beige dark:hover:bg-white/10 transition-colors">
