...
@section('title', 'إنشاء دور جديد - وزارة الاقتصاد')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex flex-wrap items-center gap-2 mb-6 text-sm">
        ...
        <span class="material-symbols-outlined text-slate-400 text-[16px] rtl-flip">chevron_left</span>
        <span class="text-primary dark:text-slate-200 font-semibold">إنشاء دور جديد</span>
    </div>

    <!-- Header -->
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">إنشاء دور جديد</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">تعريف دور جديد وتعيين الصلاحيات المناسبة له.</p>
        </div>
