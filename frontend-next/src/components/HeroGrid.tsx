...
const PromotionalCard: React.FC<PromotionalCardProps> = ({
  ...
  // Listen for videocard-play CustomEvent to hide badge when video plays
  React.useEffect(() => {
    ...
    if (section.video_url) {
      return (
        <div className="h-full min-h-[100px] rounded-[2rem] relative overflow-hidden">
          ...
          <div
            className={`absolute top-4 right-4 rtl:right-auto rtl:left-4 z-20 transition-opacity duration-300 ${isMobileDevice && isVideoPlaying ? "opacity-0 pointer-events-none" : "opacity-100"}`}
          >
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {description && (
            <p className="text-gov-beige/60 text-sm mb-6">{description}</p>
          )}
          {buttonText && (
            <a
              href={section.button_url || "#"}
...
const HeroGrid: React.FC = () => {
  ...
  return (
    <section className="py-10 md:py-16 px-6 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="absolute inset-0 p-4 md:p-8 flex flex-col justify-end z-10">
              ...
              <div className="flex gap-2">
                ...
                <FavoriteButton
                  ...
                  metadata={{
                    ...
                    title_ar:
                      getLocalizedField(heroArticle, "title", "ar") || "",
                    title_en:
                      getLocalizedField(heroArticle, "title", "en") || "",
                    description:
                      getLocalizedField(
                        heroArticle,
                        "excerpt",
                    ...
                    description_ar:
                      getLocalizedField(heroArticle, "excerpt", "ar") || "",
                    description_en:
                      getLocalizedField(heroArticle, "excerpt", "en") || "",
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1 md:gap-2 text-gov-beige/80 text-[10px] md:text-xs">
                <span className="font-semibold text-gov-gold">
                  {getLocalizedField(
                    heroArticle,
                    "category",
                    locale as "ar" | "en",
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-4 md:px-5 py-1.5 md:py-2 rounded-full bg-gov-gold text-gov-forest text-[11px] md:text-sm font-bold hover:bg-white transition-all group/btn shadow-md"
              >
                {t("hero_read_more")}
                <ArrowLeft
                  size={14}
