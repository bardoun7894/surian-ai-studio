...
import { Lock, Eye, EyeOff, ArrowRight, ArrowLeft, ChevronRight, ChevronLeft, Shield, CheckCircle } from 'lucide-react';
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-2xl shadow-xl border border-gray-100 dark:border-white/10 p-6 sm:p-8">
                        {isSuccess ? (
                            <div className="text-center py-8">
                                ...
                                <button
                                    onClick={() => onNavigate('LOGIN')}
                                    className="w-full py-3 bg-gov-teal text-white font-bold rounded-xl"
                                >
                                    {t('auth_sign_in_btn')}
                                </button>
                            </div>
