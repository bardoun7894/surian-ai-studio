...
@section('title', 'تعديل فرصة استثمارية - وزارة الاقتصاد')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-2 mb-6">
        ...
        <span class="text-slate-400 text-sm">/</span>
        <span class="text-slate-900 dark:text-white text-sm font-semibold">تعديل</span>
    </div>

    <!-- Header -->
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">تعديل الفرصة الاستثمارية</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">تحديث بيانات الفرصة: {{ $investment->title_ar }}</p>
        </div>
            ...
            <div class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title_ar" value="{{ old('title_ar', $investment->title_ar) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description_ar" rows="6"
                            ...
                            placeholder="وصف تفصيلي للفرصة الاستثمارية...">{{ old('description_ar', $investment->description_ar) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="sector_ar" value="{{ old('sector_ar', $investment->sector_ar) }}"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                        ...
                        <div>
                            ...
                            <input type="text" name="location_ar" value="{{ old('location_ar', $investment->location_ar) }}"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                ...
                <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title_en" value="{{ old('title_en', $investment->title_en) }}" dir="ltr"
                            class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description_en" rows="6" dir="ltr"
                            class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400 leading-relaxed p-4"
                            placeholder="Detailed description of the investment opportunity...">{{ old('description_en', $investment->description_en) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="sector_en" value="{{ old('sector_en', $investment->sector_en) }}" dir="ltr"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                        ...
                        <div>
                            ...
                            <input type="text" name="location_en" value="{{ old('location_en', $investment->location_en) }}" dir="ltr"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                ...
                <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-5">
                    ...
                    <div class="flex flex-col gap-4">
                        <div>
                            ...
                            <input type="number" name="investment_amount" value="{{ old('investment_amount', $investment->investment_amount) }}" step="0.01" min="0"
                        ...
                        <div>
                            ...
                            <select name="currency" class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm">
                                <option value="SYP" {{ (old('currency') ?? $investment->currency) == 'SYP' ? 'selected' : '' }}>ليرة سورية (SYP)</option>
                                <option value="USD" {{ (old('currency') ?? $investment->currency) == 'USD' ? 'selected' : '' }}>دولار أمريكي (USD)</option>
                                <option value="EUR" {{ (old('currency') ?? $investment->currency) == 'EUR' ? 'selected' : '' }}>يورو (EUR)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm">
                                <option value="available" {{ (old('status') ?? $investment->status) == 'available' ? 'selected' : '' }}>متاحة</option>
                                <option value="under_review" {{ (old('status') ?? $investment->status) == 'under_review' ? 'selected' : '' }}>قيد المراجعة</option>
                                <option value="closed" {{ (old('status') ?? $investment->status) == 'closed' ? 'selected' : '' }}>مغلقة</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="category" value="{{ old('category', $investment->category) }}"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm"
                        ...
                        <div>
                            ...
                            <input type="number" name="order" value="{{ old('order', $investment->order) }}" min="0"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm">
                ...
                <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-5">
                    ...
                    <div class="flex flex-col gap-4">
                        <div>
                            ...
                            <input type="email" name="contact_email" value="{{ old('contact_email', $investment->contact_email) }}" dir="ltr"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm"
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_phone" value="{{ old('contact_phone', $investment->contact_phone) }}" dir="ltr"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm"
                ...
                <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-5">
                    ...
                    <div class="flex flex-col gap-4">
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $investment->is_active) ? 'checked' : '' }}
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $investment->is_featured) ? 'checked' : '' }}
                                class="w-5 h-5 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary focus:ring-offset-0">
                            <div>
