...
@section('title', 'إضافة قسم ترويجي - وزارة الاقتصاد')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-2 mb-6">
        ...
        <span class="text-slate-400 text-sm">/</span>
        <span class="text-slate-900 dark:text-white text-sm font-semibold">إضافة قسم جديد</span>
    </div>

    <!-- Header -->
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">إضافة قسم ترويجي</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">إنشاء بانر أو قسم ترويجي جديد للموقع.</p>
        </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.promotional.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="description_ar" rows="4"
                                ...
                                placeholder="وصف مختصر للقسم الترويجي...">{{ old('description_ar') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="button_text_ar" value="{{ old('button_text_ar') }}"
                                    class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                            ...
                            <div>
                                ...
                                <input type="url" name="button_url" value="{{ old('button_url') }}" dir="ltr"
                                    class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                ...
                <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="button_text_en" value="{{ old('button_text_en') }}" dir="ltr"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white focus:ring-primary focus:border-primary placeholder:text-slate-400"
                    ...
                    <div class="flex flex-col gap-4">
                        <div>
                            ...
                            <select name="type" required class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm">
                                ...
                                <option value="promo" {{ old('type') == 'promo' ? 'selected' : '' }}>ترويجي</option>
                                <option value="stats" {{ old('type') == 'stats' ? 'selected' : '' }}>إحصائيات</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="position" required class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm">
                                ...
                                <option value="hero" {{ old('position') == 'hero' ? 'selected' : '' }}>الرئيسي</option>
                                <option value="grid_main" {{ old('position') == 'grid_main' ? 'selected' : '' }}>الشبكة الرئيسية</option>
                                <option value="grid_side" {{ old('position') == 'grid_side' ? 'selected' : '' }}>الشبكة الجانبية</option>
                                <option value="grid_bottom" {{ old('position') == 'grid_bottom' ? 'selected' : '' }}>أسفل الشبكة</option>
                            </select>
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <input type="text" value="{{ old('background_color', '#ffffff') }}" dir="ltr" readonly
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" value="{{ old('icon') }}" dir="ltr"
                                class="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-primary focus:border-primary text-sm"
