...
const translations: Record<string, Record<Language, string>> = {
  ...
  // External Link Modal
  'external_link_warning_title': { ar: 'سيتم توجيهك إلى موقع خارجي', en: 'You will be redirected to an external website' },
  'external_link_warning_desc': { ar: 'هل ترغب في المتابعة؟', en: 'Do you wish to continue?' },
  ...
  'complaint_success_desc': { ar: 'يرجى الاحتفاظ برقم تتبع الشكوى أدناه لمتابعة حالة الشكوى. تم إرسال رسالة تأكيد لرقم هاتفك.', en: 'Please keep the complaint tracking number below to track your complaint. A confirmation message has been sent to your phone.' },
  'complaint_ticket_number': { ar: 'رقم تتبع الشكوى', en: 'Complaint Tracking Number' },
  ...
  'complaint_track_subtitle': { ar: 'أدخل رقم تتبع الشكوى للاستعلام عن آخر المستجدات.', en: 'Enter the complaint tracking number to inquire about the latest updates.' },
  'complaint_track_identified': { ar: 'تتبع بالهوية', en: 'Track with ID' },
  'complaint_track_anonymous': { ar: 'تتبع مجهول', en: 'Anonymous Track' },
  'complaint_track_identified_desc': { ar: 'أدخل رقم تتبع الشكوى والرقم الوطني للتحقق', en: 'Enter complaint tracking number and national ID to verify' },
  ...
  'complaint_ticket_label': { ar: 'رقم تتبع الشكوى', en: 'Complaint Tracking Number' },
  ...
  'complaint_ticket_prefix': { ar: 'تتبع شكوى #', en: 'Complaint Track #' },
  ...
  'ql_directorates': { ar: 'المديريات', en: 'Directorates' },
  ...
  'complaint_prev_ticket': { ar: 'رقم تذكرة الشكوى السابقة', en: 'Previous Ticket Number' },
  'complaint_prev_ticket_hint': { ar: 'يرجى إدخال رقم تتبع الشكوى السابقة لربطها بهذه الشكوى وتسريع المعالجة.', en: 'Please enter the previous complaint tracking number to link it to this complaint and speed up processing.' },
  ...
  'complaint_found': { ar: 'تم العثور على التذكرة', en: 'Ticket found' },
  'complaint_status_label': { ar: 'حالة الشكوى:', en: 'Complaint Status:' },
  'complaint_verify_ticket_id': { ar: 'تأكد من صحة رقم تتبع الشكوى والرقم الوطني', en: 'Please verify the complaint tracking number and national ID' },
