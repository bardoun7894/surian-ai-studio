...
const translations: Record<string, Record<Language, string>> = {
  ...
  'suggestion_tracking_number': { ar: 'رقم تتبع المقترح', en: 'Suggestion Tracking Number' },
  ...
  // Media Center translations (Bug 6 fix)
  'media_center': { ar: 'المركز الإعلامي', en: 'Media Center' },
  'media_subtitle': { ar: 'مكتبة الفيديو والصور والإنفوجرافيك الرسمية من وزارة الاقتصاد والصناعة', en: 'Official video, photo, and infographic library from the Ministry of Economy and Industry' },
  'media_all': { ar: 'الكل', en: 'All' },
  'media_videos': { ar: 'فيديو', en: 'Videos' },
  'media_photos': { ar: 'صور', en: 'Photos' },
  'media_infographics': { ar: 'إنفوجرافيك', en: 'Infographics' },
  'media_period': { ar: 'الفترة', en: 'Period' },
  'media_month': { ar: 'الشهر', en: 'Month' },
  'media_year': { ar: 'السنة', en: 'Year' },
  'media_items': { ar: 'عنصر', en: 'items' },
  'media_download': { ar: 'تحميل', en: 'Download' },
  'media_downloading': { ar: 'جار التحميل...', en: 'Downloading...' },
  'media_share': { ar: 'مشاركة', en: 'Share' },
  'media_play': { ar: 'تشغيل', en: 'Play' },
  'media_pause': { ar: 'إيقاف', en: 'Pause' },
  'media_expand': { ar: 'توسيع', en: 'Expand' },
  'media_close': { ar: 'إغلاق', en: 'Close' },
  'media_back_to_album': { ar: 'العودة للألبوم', en: 'Back to Album' },
  'media_photo': { ar: 'صورة', en: 'Photo' },
  'media_photos_count': { ar: 'صورة', en: 'photos' },
  'media_no_items': { ar: 'لا توجد عناصر', en: 'No Items Found' },
  'media_no_content': { ar: 'لا يوجد محتوى في هذه الفئة حالياً', en: 'No content in this category currently' },
  'media_no_album_photos': { ar: 'لا توجد صور في هذا الألبوم', en: 'No photos in this album' },
  'media_video': { ar: 'فيديو', en: 'Video' },
  'media_infographic': { ar: 'إنفوجرافيك', en: 'Infographic' },
  'media_clear_filter': { ar: 'محو الفلتر', en: 'Clear filters' },
  'media_all_months': { ar: 'الكل', en: 'All' },
  'media_all_years': { ar: 'الكل', en: 'All' },
  // Bug fix: Complaint form validation messages (bilingual)
  'complaint_phone_invalid': { ar: 'يرجى إدخال رقم هاتف صالح', en: 'Please enter a valid phone number' },
  'complaint_name_required': { ar: 'الاسم الأول مطلوب', en: 'First name is required' },
  'complaint_father_name_required': { ar: 'اسم الأب مطلوب', en: 'Father name is required' },
  'complaint_last_name_required': { ar: 'اسم العائلة مطلوب', en: 'Last name is required' },
  'complaint_dob_required': { ar: 'تاريخ الميلاد مطلوب', en: 'Date of birth is required' },
  'complaint_description_required': { ar: 'تفاصيل الشكوى مطلوبة', en: 'Complaint details are required' },
  'complaint_description_min': { ar: 'تفاصيل الشكوى يجب أن تكون 10 أحرف على الأقل', en: 'Complaint details must be at least 10 characters' },
  'complaint_template_required': { ar: 'يرجى اختيار نوع الشكوى', en: 'Please select a complaint type' },
  'complaint_prev_tracking_required': { ar: 'رقم الشكوى السابقة مطلوب', en: 'Previous complaint tracking number is required' },
  'complaint_email_required': { ar: 'البريد الإلكتروني مطلوب', en: 'Email is required' },
  'complaint_phone_required': { ar: 'رقم الهاتف مطلوب', en: 'Phone number is required' },
  'complaint_rate_limit_exceeded': { ar: 'لقد تجاوزت الحد المسموح من الشكاوى اليومية. يرجى المحاولة غداً.', en: 'You have exceeded the daily complaint limit. Please try again tomorrow.' },
  'suggestion_rate_limit_exceeded': { ar: 'لقد تجاوزت الحد المسموح من المقترحات اليومية. يرجى المحاولة غداً.', en: 'You have exceeded the daily suggestion limit. Please try again tomorrow.' },
  'complaint_validation_fix_errors': { ar: 'يرجى تصحيح الأخطاء في النموذج قبل الإرسال', en: 'Please fix the errors in the form before submitting' },
};
